...
public class ExportUtil {
    ...
    public static File writeExcel(String directory, String fileName, String sheetName, List<String> columnNames,
                                  String sheetTitle, List<List<Object>> objects, boolean append) throws CommonException, IOException {
    ...
    //                                    String sheetTitle, boolean append) throws CommonException, IOException {
    //     File tmpFile = assertFile(directory, fileName);
    ...
    //  * @throws CommonException
    //  */
    // private static File exportExcelData(File file, String sheetName, List<List<Object>> objects) throws CommonException, IOException {
    //     // 声明一个工作薄
    //     Workbook workBook;
    //     if (file.exists()) {
    //         // 声明一个工作薄
    ...
    public static void main(String[] args) {
        ...
        //写入标题--第二种方式
        // ExportUtil.writeExcelTitle("E:\\temp", "a", sheetName, columnNames, sheetTitle, false);
        ...
        try {
            //写入数据--第二种方式
            // ExportUtil.writeExcelData("E:\\temp", "a1", sheetName, objects);

            //直接写入数据--第一种方式
            ExportUtil.writeExcel("E:\\temp", "a2", sheetName, columnNames, sheetTitle, objects, false);
        } catch (Exception e) {
            e.printStackTrace();
        }
