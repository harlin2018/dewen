    ...
    <el-form class="main_form" :model="mainForm" ref="mainForm">
        <table class="my_table_form">
            ...
            <tr>
                <td>一般工业固体废物</td>
                <td class="td75">
                    <el-form-item prop="generalIndustrialSolidWaste" :rules="[rule.required]">
            ...
            <tr>
                <td>年产生量</td>
                <td class="td75">
                    <el-form-item prop="yearProduction" :rules="[rule.required]">
            ...
            <tr>
                <td>年处理量</td>
                <td class="td75">
                    <el-form-item prop="yearProcess" :rules="[rule.required]">
            ...
            <tr>
                ...
                <td class="td75">
                    <el-row>
                        <el-col :span="8">
                            <el-form-item prop="disposalWay" :rules="[rule.required]">
                        ...
                        <el-col :span="16" v-if="mainForm.disposalWay==1">
                            <el-form-item prop="disposalWayRemark" :rules="[rule.required]">
                    ...
                    <table class="my_table_form my_table_inner_row">
                        <tr>
                            ...
                            <td class="td75 row_add">
                                <el-form-item :prop="'companyWasteList.'+index+'.nameType'" :rules="[rule.required]">
                        ...
                        <tr>
                            <td>年产生量</td>
                            <td class="td75">
                                <el-form-item :prop="'companyWasteList.'+index+'.yearPro'" :rules="[rule.required]">
                        ...
                        <tr>
                            <td>年处理量</td>
                            <td class="td75">
                                <el-form-item :prop="'companyWasteList.'+index+'.yearProcess'" :rules="[rule.required]">
                        ...
                        <tr>
                            ...
                            <td class="td75">
                                <el-row>
                                    <el-col :span="8">
                                        <el-form-item :prop="'companyWasteList.'+index+'.processMethods'" :rules="[rule.required]">
                                    ...
                                    <el-col :span="16" v-if="item.processMethods==1">
                                        <el-form-item :prop="'companyWasteList.'+index+'.processMethodsRemark'" :rules="[rule.required]">
            ...
            <tr>
                <td>主要声源名称</td>
                <td class="td75">
                    <el-form-item prop="mainSoundSourceName" :rules="[rule.required]">
            ...
            <tr>
                <td>污染防治的主要措施</td>
                <td class="td75">
                    <el-form-item prop="mmppc" :rules="[rule.required]">
            ...
            <tr>
                <td>排向</td>
                <td class="td75">
                    <el-form-item prop="rowTo" :rules="[rule.required]">
            ...
            <tr>
                <td>产生量（月平均）</td>
                <td class="td75">
                    <el-form-item prop="output" :rules="[rule.required]">
            ...
            <tr>
                ...
                <td class="td75">
                    <el-row>
                        <el-col :span="8">
                            <el-form-item prop="theSewageTo" :rules="[rule.required]">
                        ...
                        <el-col :span="16" v-if="mainForm.theSewageTo==3">
                            <el-form-item prop="theSewageToRemark" :rules="[rule.required]">
            ...
            <tr>
                <td>化粪池</td>
                <td class="td75">
                    <el-form-item prop="stfds" :rules="[rule.required]">
            ...
            <tr>
                <td>产生量（月平均）</td>
                <td class="td75">
                    <el-form-item prop="lifeProduced" :rules="[rule.required]">
            ...
            <tr>
                ...
                <td class="td75">
                    <el-row>
                        <el-col :span="8">
                            <el-form-item prop="lifeLineTo" :rules="[rule.required]">
                        ...
                        <el-col :span="16" v-if="mainForm.lifeLineTo==3">
                            <el-form-item prop="lifeLineToRemark" :rules="[rule.required]">
            ...
            <tr>
                <td>废水监督性检测周期</td>
                <td class="td75">
                    <el-form-item prop="sicfwwo" :rules="[rule.required]">
            ...
            <tr>
                <td>废气监督性检测周期</td>
                <td class="td75">
                    <el-form-item prop="sicfwwt" :rules="[rule.required]">
            ...
            <tr>
                <td>土壤监督性检测周期</td>
                <td class="td75">
                    <el-form-item prop="sicfwws" :rules="[rule.required]">
